...
$rformaction = 'change_user_blocks.php'; // This must be set for the include to work
$where_am_i = "change_user_blocks.php?v=$v";
include('inserts/admin_change_blocks.ins.php');
