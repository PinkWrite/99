...
if (mysqli_num_rows($r) == 0) {
	...
	<tr><th>Writer</th><th class="bulk_check" style="display: none;"></th><th>Editor</th><th>Writs</th><th>Blocks</th><th>Account</th><th>Password</th></tr>';
	...
	while ($row = mysqli_fetch_array($r)) {
		...
		get_switch("Writs", "View all writs from this writer", "writs_sup.php", "w", $u_id, "editNoteButton");
		echo '</div>
			</td>
			<td><div style="display: inline; float:left;">';
