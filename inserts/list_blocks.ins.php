...
if (($SQLcolumnSearch == '') || (!isset($SQLcolumnSearch))) {
	...
	set_switch("List", "List writs for this block", "block.php?v=0", "opened_by", "no_value", "editNoteButton");
	echo '</div>
		</td>
		<td><div style="display: inline; float:right;">';
...
while ($rowb = mysqli_fetch_array($rb)) {
	...
	echo '<tr class="'.$cc.'">
		...
		<td><div style="display: inline; float:right;">';
	set_switch("Browse &rarr;", "Browse tasks for this block", "block.php?v=$block_id", "opened_by", $userid, "editNoteButton");
	echo '</div>
		</td>
		<td><div style="display: inline; float:right;">';
