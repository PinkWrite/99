...
echo '<p><input type="submit" name="create" class="lt_button" value="Create observer"></p></form>';
echo '<table class="list"><tr><th>Name</th><th>Username</th><th>Email</th><th>Status</th><th></th></tr>';
foreach ($app->user->listByFacility($fid, 'observer') as $row) {
