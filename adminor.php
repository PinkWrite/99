...
$active_staffing = '';
$active_locker = '';
$active_admin = 'activedash';
$active_editor = '';
$active_observer = '';
$active_dash = '';
$page_title = "Admin :: $siteTitle";
...
if (isset($_SESSION['user_id'])) {
	...
	$dashgreeting = "Admin Dash for $u_name";
...
$where_am_i = "adminor.php";
include('inserts/list_blocks_sup.ins.php');

// Tasks table
// echo '<h2 class="lt">Tasks</h2>';
// include('inserts/list_tasks_sup.ins.php');
